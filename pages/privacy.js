...
export default function Privacy() {
  return (
    <Layout title="Privacy Policy" description="CREATORUSFLOW's privacy policy and data protection practices">
      <section className="hero-bg section-padding animate-on-scroll">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            At CREATORUSFLOW, we are committed to protecting your privacy. This policy outlines how we collect, use, and safeguard your information.
          </p>
        </div>
      </section>
