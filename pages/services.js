...
const PlatformIcon = ({ platform, size = 18 }) => {
  const icons = {
    ...
    snapchat: (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="#000000" strokeWidth="0.4" strokeLinejoin="round">
          ...
          <div className="card" key={active}>
            ...
            >
              <div
                ...
                style={{ background: platform.iconBg || platform.border, color: platform.iconBg ? platform.activeText : platform.iconColor }}
              >
