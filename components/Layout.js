      ...
      <footer style={{ background: '#0D1526', borderTop: 'none' }}>
        <div className="container-custom px-4 sm:px-6 lg:px-8 py-10 md:py-16">
          ...
          <div className="md:hidden text-center mb-8">
            ...
            <p className="text-slate-400 text-xs leading-relaxed mb-4 max-w-xs mx-auto">
            ...
            <div className="grid grid-cols-2 gap-6 text-left mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-slate-400">
                  <li><a href="mailto:info@creatorflowus.com" className="hover:text-white transition-colors" style={{ wordBreak: 'break-all' }}>info@creatorflowus.com</a></li>
